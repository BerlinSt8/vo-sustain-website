...
export const translations = {
  de: {
    ...
    ueberUns: {
      ...
      quote: "Ich sitze auf der anderen Seite des Tisches. Als aktiver ZIM-Netzwerkmanager weiß ich, was Gutachter lesen wollen — und was einen Antrag scheitern lässt.",
      bioParagraphs: [
        "Förderanträge scheitern selten an der Idee — sie scheitern an Formfehlern, falscher Programmwahl und fehlender Compliance. Als aktiver ZIM-Netzwerkmanager kenne ich beide Seiten: die Perspektive des Antragstellers und die Bewertungslogik der Gutachter. Dieses Wissen fließt in jedes Konzept, das ich für Sie erstelle.",
        "Ich koordiniere das internationale ZIM-Innovationsnetzwerk SEAWEED DECARBON POLYMER — 12 Partner in Deutschland, Spanien, Malaysia und Indonesien. Keine Theorie, kein Lehrbuchwissen: Ich manage Konstellationslogik, Technologie-Roadmaps und Partnerabstimmung über Zeitzonen hinweg. Wenn ich Ihren ZIM-Antrag schreibe, tue ich das mit der Erfahrung von jemandem, der das Programm von innen kennt.",
        "Bevor ich in die Förderwelt kam, habe ich fünf Jahre in Indonesien Compliance-Systeme für EU-Bio-Zertifizierung aufgebaut — 170 Produzenten, 280 Hektar, fünf Verarbeitungsstandorte. Die Audit-Checklisten, Dokumentationsstandards und Rückverfolgbarkeitssysteme, die ich dort entwickelt habe, sind heute meine Blaupause für Verwendungsnachweise und Fördermittel-Compliance.",
        "Ich arbeite nicht mit einem Programm — ich navigiere durch die gesamte deutsche und europäische Förderlandschaft. ZIM, BAFA EEW, EFRE, SAB, INNO-KOM, Horizon Europe, LIFE, Forschungszulage: Über zehn Programme, die ich aktiv nutze und deren Kumulierungsregeln ich kenne. Für Sie bedeutet das: eine Analyse, die nicht bei einem Programm aufhört, sondern die optimale Kombination findet.",
        "Mein Ansatz ist anders als der anderer Berater: Sie bekommen ein fertiges Förderkonzept, bevor wir uns zum ersten Mal sprechen. Kein Erstgespräch, bei dem erst einmal Fragen gestellt werden. Kein Honorar, bevor Fördermittel auf Ihrem Konto liegen. Und eine KI-gestützte Analyse, die 349 Programme in Minuten durchsucht statt in Wochen.",
        "VO Sustain existiert für einen Markt: Cleantech und Nachhaltigkeit. Keine Generalisten-Beratung, die alles ein bisschen kann. Sondern spezialisiertes Fördermanagement für Unternehmen, die in Energieeffizienz, Kreislaufwirtschaft, Bioökonomie oder Dekarbonisierung investieren — mit einem Berater, der in genau diesem Feld arbeitet.",
      ],
      ...
      expertiseCards: [
        ...
        },
        {
          ...
          desc: "Ihre Fördermittel sind nur sicher, wenn Verwendungsnachweise stimmen. Meine Compliance-Systeme — entwickelt für EU-Bio-Zertifizierung mit 170+ Produzenten — sind heute die Grundlage für audit-sichere Förderdokumentation.",
          tags: ["EU-Bio", "NOP", "Audit", "Rückverfolgbarkeit"],
        },
        {
          title: "Internationales Netzwerkmanagement",
          desc: "12 Partner, 4 Länder, asynchrone Workflows seit 2014. Ich koordiniere verteilte Teams über Zeitzonen hinweg — von der Technologie-Roadmap bis zum Meilensteintreffen.",
  ...
  en: {
    ...
    ueberUns: {
      ...
      quote: "I sit on the other side of the table. As an active ZIM network manager, I know what reviewers want to read — and what makes an application fail.",
      bioParagraphs: [
        "Grant applications rarely fail because of the idea — they fail because of formal errors, wrong programme selection, and missing compliance. As an active ZIM network manager, I know both sides: the applicant's perspective and the reviewer's evaluation logic. This knowledge flows into every proposal I create for you.",
        "I coordinate the international ZIM innovation network SEAWEED DECARBON POLYMER — 12 partners in Germany, Spain, Malaysia, and Indonesia. No theory, no textbook knowledge: I manage constellation logic, technology roadmaps, and partner coordination across time zones. When I write your ZIM application, I do it with the experience of someone who knows the programme from the inside.",
        "Before I entered the funding world, I spent five years in Indonesia building compliance systems for EU organic certification — 170 producers, 280 hectares, five processing sites. The audit checklists, documentation standards, and traceability systems I developed there are now my blueprint for utilisation reports and grant compliance.",
        "I don't work with one programme — I navigate the entire German and European funding landscape. ZIM, BAFA EEW, EFRE, SAB, INNO-KOM, Horizon Europe, LIFE, Research Allowance: over ten programmes that I actively use and whose cumulation rules I know. For you, this means an analysis that doesn't stop at one programme but finds the optimal combination.",
        "My approach is different from other consultants: you receive a complete funding proposal before we speak for the first time. No initial meeting where questions are asked first. No fee before funding lands in your account. And an AI-powered analysis that searches 349 programmes in minutes instead of weeks.",
        "VO Sustain exists for one market: cleantech and sustainability. No generalist consultancy that does a bit of everything. Instead, specialised grant management for companies investing in energy efficiency, circular economy, bioeconomy, or decarbonisation — with a consultant who works in exactly this field.",
      ],
      ...
      expertiseCards: [
        ...
        },
        {
          ...
          desc: "Your funding is only secure if utilisation reports are correct. My compliance systems — developed for EU organic certification with 170+ producers — are now the foundation for audit-proof grant documentation.",
          tags: ["EU Organic", "NOP", "Audit", "Traceability"],
        },
        {
          title: "International Network Management",
          desc: "12 partners, 4 countries, asynchronous workflows since 2014. I coordinate distributed teams across time zones — from technology roadmaps to milestone meetings.",
