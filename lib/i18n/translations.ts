...
export const translations = {
  de: {
    ...
    about: {
      ...
      quote: "Wir schreiben die Anträge, die wir als aktive ZIM-Netzwerkmanager auch begutachten lassen. Wir kennen beide Seiten des Prozesses.",
      credentials: [
    ...
    ueberUns: {
      heroLabel: "ÜBER UNS",
      heroHeadline: "VO Sustain.",
      heroSub: "Förderberatung für Cleantech-KMU. ZIM-Netzwerkmanagement. Berlin.",
      imgAlt: "Denis Jänicke — Gründer VO Sustain, Förderberatung Berlin",
      bioHeadline: "Denis Jänicke",
      bioSubtitle: "Gründer · VO Sustain · Berlin",
      quote: "Wir sitzen auf der anderen Seite des Tisches. Unser Team kennt die Bewertungslogik der Gutachter, weil wir selbst ein ZIM-Netzwerk mit 12 Partnern in vier Ländern koordinieren.",
      bioParagraphs: [
        "Förderanträge scheitern selten an der Idee. Sie scheitern an Formfehlern, falscher Programmwahl und fehlender Compliance. Bei VO Sustain kennen wir beide Seiten: die Perspektive des Antragstellers und die Bewertungslogik der Gutachter. Diese Erfahrung steckt in jedem Konzept, das wir für Sie erstellen.",
        "Unser Gründer koordiniert das internationale ZIM-Innovationsnetzwerk SEAWEED DECARBON POLYMER mit 12 Partnern in Deutschland, Spanien, Malaysia und Indonesien. Das ist kein Lehrbuchwissen. Wir arbeiten täglich mit Technologie-Roadmaps, Partnerabstimmung über Zeitzonen und den Anforderungen von Projektträgern. Wenn wir Ihren ZIM-Antrag schreiben, tun wir das mit der Erfahrung von jemandem, der das Programm von innen kennt.",
        "Unsere Compliance-Expertise hat ungewöhnliche Wurzeln: fünf Jahre Aufbau von Audit-Systemen für EU-Bio-Zertifizierung in Indonesien. 170 Produzenten, 280 Hektar, fünf Verarbeitungsstandorte, mehrere Audit-Zyklen mit CERES. Die Dokumentationsstandards und Rückverfolgbarkeitssysteme aus dieser Zeit sind heute unsere Blaupause für Verwendungsnachweise und Fördermittel-Compliance.",
        "Wir arbeiten nicht mit einem Programm. Wir navigieren durch die gesamte deutsche und europäische Förderlandschaft: ZIM, BAFA EEW, EFRE, SAB, INNO-KOM, Horizon Europe, LIFE, Forschungszulage. Über zehn Programme, deren Kumulierungsregeln wir kennen. Für Sie heißt das: eine Analyse, die nicht beim erstbesten Programm aufhört, sondern die optimale Kombination findet.",
        "Unser Ansatz unterscheidet uns von anderen Beratern: Sie bekommen ein fertiges Förderkonzept, bevor wir uns zum ersten Mal sprechen. Kein Honorar, bevor Fördermittel auf Ihrem Konto liegen. Und eine KI-gestützte Analyse, die 349 Programme in Minuten durchsucht.",
        "VO Sustain ist auf einen Markt spezialisiert: Cleantech und Nachhaltigkeit. Wir sind keine Generalisten, die alles ein bisschen können. Wir machen Fördermanagement für Unternehmen, die in Energieeffizienz, Kreislaufwirtschaft, Bioökonomie oder Dekarbonisierung investieren.",
      ],
      statsLabel: "IN ZAHLEN",
      stats: [
        { value: "10+", label: "Förderprogramme aktiv genutzt" },
        { value: "12+", label: "Partner im ZIM-Netzwerk" },
        { value: "4", label: "Länder (DE, ES, MY, ID)" },
        { value: "349", label: "Programme im Quick-Check" },
        { value: "95%", label: "Förderquote ZIM Phase 1" },
        { value: "0€", label: "Erstanalyse — kostenlos" },
      ],
      ...
      expertiseCards: [
        ...
        {
          title: "Compliance & Audit-Sicherheit",
          desc: "Fördermittel sind nur sicher, wenn Verwendungsnachweise stimmen. Unsere Compliance-Systeme basieren auf EU-Bio-Zertifizierung mit 170+ Produzenten und bilden die Grundlage für audit-sichere Förderdokumentation.",
          tags: ["EU-Bio", "NOP", "Audit", "Rückverfolgbarkeit"],
        },
        {
          title: "Internationales Netzwerkmanagement",
          desc: "12 Partner, 4 Länder, asynchrone Workflows seit 2014. Wir koordinieren verteilte Teams über Zeitzonen hinweg, von der Technologie-Roadmap bis zum Meilensteintreffen.",
  ...
  en: {
    ...
    about: {
      ...
      quote: "We write the applications we also have reviewed as active ZIM network managers. We know both sides of the process.",
      credentials: [
    ...
    ueberUns: {
      heroLabel: "ABOUT US",
      heroHeadline: "VO Sustain.",
      heroSub: "Grant consulting for cleantech SMEs. ZIM network management. Berlin.",
      imgAlt: "Denis Jänicke — Founder VO Sustain, Grant Consulting Berlin",
      bioHeadline: "Denis Jänicke",
      bioSubtitle: "Founder · VO Sustain · Berlin",
      quote: "We sit on the other side of the table. Our team knows the reviewer's evaluation logic because we coordinate a ZIM network with 12 partners across four countries ourselves.",
      bioParagraphs: [
        "Grant applications rarely fail because of the idea. They fail because of formal errors, wrong programme selection, and missing compliance. At VO Sustain, we know both sides: the applicant's perspective and the reviewer's evaluation logic. That experience goes into every proposal we create for our clients.",
        "Our founder coordinates the international ZIM innovation network SEAWEED DECARBON POLYMER with 12 partners in Germany, Spain, Malaysia, and Indonesia. This is not textbook knowledge. We work daily with technology roadmaps, partner coordination across time zones, and project agency requirements. When we write your ZIM application, we do it with insider experience of how the programme actually works.",
        "Our compliance expertise has unusual roots: five years building audit systems for EU organic certification in Indonesia. 170 producers, 280 hectares, five processing sites, multiple audit cycles with CERES. The documentation standards and traceability systems from that time are now our blueprint for utilisation reports and grant compliance.",
        "We do not work with one programme. We navigate the entire German and European funding landscape: ZIM, BAFA EEW, EFRE, SAB, INNO-KOM, Horizon Europe, LIFE, Research Allowance. Over ten programmes whose cumulation rules we know. For you, that means an analysis that does not stop at the first matching programme but finds the optimal combination.",
        "Our approach sets us apart: you receive a complete funding proposal before we speak for the first time. No fee before funding lands in your account. And an AI-powered analysis that searches 349 programmes in minutes.",
        "VO Sustain specialises in one market: cleantech and sustainability. We are not generalists. We do grant management for companies investing in energy efficiency, circular economy, bioeconomy, or decarbonisation.",
      ],
      statsLabel: "BY THE NUMBERS",
      stats: [
        { value: "10+", label: "Funding programmes actively used" },
        { value: "12+", label: "Partners in ZIM network" },
        { value: "4", label: "Countries (DE, ES, MY, ID)" },
        { value: "349", label: "Programmes in Quick-Check" },
        { value: "95%", label: "ZIM Phase 1 funding rate" },
        { value: "0€", label: "Initial analysis — free" },
      ],
      expertiseLabel: "EXPERTISE",
      ...
      expertiseCards: [
        ...
        {
          title: "Compliance & Audit Safety",
          desc: "Funding is only secure if utilisation reports are correct. Our compliance systems, built on EU organic certification with 170+ producers, are the foundation for audit-proof grant documentation.",
          tags: ["EU Organic", "NOP", "Audit", "Traceability"],
        },
        {
          title: "International Network Management",
          desc: "12 partners, 4 countries, asynchronous workflows since 2014. We coordinate distributed teams across time zones, from technology roadmaps to milestone meetings.",
