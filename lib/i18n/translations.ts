...
export const translations = {
  de: {
    ...
    nachhaltigkeitsstrategie: {
      ...
      scope: [
        ...
        { title: "THG-Bilanz & Carbon Footprint", desc: "Systematische Erfassung aller Treibhausgasemissionen nach GHG Protocol: Scope 1 (Direktemissionen aus eigenen Anlagen, Fuhrpark, Prozesse) und Scope 2 (eingekaufte Energie — Strom, Fernwärme, Dampf). Die THG-Bilanz ist Pflichtgrundlage für BAFA-Förderanträge, CSRD-Berichterstattung und die Teilnahme an der EU-Taxonomie-Klassifizierung." },
        { title: "Fördermittel-Matching für Nachhaltigkeitsmaßnahmen", desc: "Jede identifizierte Maßnahme wird systematisch mit passenden Förderprogrammen abgeglichen — von BAFA EEW über KfW-Energieeffizienzprogramme bis zu SAB-Landesförderung und EU-LIFE. Wir prüfen Kumulierbarkeit, De-minimis-Spielräume und optimale Antragszeitpunkte, damit kein Förderpotenzial ungenutzt bleibt." },
      ],
      process: [
        { step: "01", title: "Analyse & Erstgespräch", desc: "Unternehmensprofil, Branche, bisherige Maßnahmen und Förderstatus klären. Erste Einschätzung des Förderpotenzials und relevanter Programme. Wir identifizieren dabei auch Quick Wins — Maßnahmen mit hohem Förderpotenzial und schnellem ROI. Kostenlos und ohne Verpflichtung." },
        { step: "02", title: "THG-Bilanz & Wesentlichkeit", desc: "Berechnung der Scope 1 & 2 Emissionen, Energiebilanz und Ressourcenverbrauch. Wesentlichkeitsmatrix: Wo ist Handlungsbedarf, was ist förderbar, was schützt Lieferkettenbeziehungen? Die Ergebnisse werden direkt als Datengrundlage für BAFA- und KfW-Anträge aufbereitet." },
        { step: "03", title: "Strategie & Roadmap", desc: "Priorisierter Maßnahmenplan mit Kosten-Nutzen-Abschätzung, eingeplanten Fördermitteln und THG-Reduktionspfad. Jede Maßnahme enthält eine Fördermittel-Zuordnung mit realistischer Bewilligungswahrscheinlichkeit. Ergebnis: ein 3-Jahres-Fahrplan, den Ihr Team umsetzen kann." },
        { step: "04", title: "Umsetzung & Monitoring", desc: "Begleitung der Maßnahmenumsetzung, Förderantragsstellung für priorisierte Investitionen, quartalsweises KPI-Reporting und Anpassung bei regulatorischen Änderungen. Wir übernehmen auch die Verwendungsnachweise und stellen die fristgerechte Auszahlung der bewilligten Mittel sicher." },
      ],
      facts: [
    ...
    ueberUns: {
      ...
      quote: "Acht Jahre Labor, fünf Jahre Compliance-Audits in Indonesien, sechs bewilligte Förderprojekte in Deutschland — wer Rückverfolgbarkeit für 170 Kleinbauern aufgebaut hat, bringt jeden Verwendungsnachweis durch.",
      bioParagraphs: [
        "Mein Weg in die Förderberatung beginnt im Labor. Acht Jahre organische Synthese, HPLC/MS-Analytik und Laborleitung bei der CTA/ASCA GmbH Berlin (2006–2014) haben mir beigebracht, wie man komplexe Prozesse dokumentiert, Ergebnisse nachweisbar macht und unter regulatorischen Anforderungen arbeitet. Genau diese Fähigkeiten braucht ein Förderantrag: technisches Risiko belegen, Neuheitsgrad nachweisen, Meilensteine messbar definieren.",
        "2014 ging ich nach Indonesien. Als Manager Supply Chain & Organic Compliance bei Atlantis Handelskontor und als selbstständiger Berater habe ich EU- und NOP-Bio-Zertifizierungen für ~170 Kleinbauern auf über 280 ha Anbaufläche aufgebaut — inklusive batch-basierter Rückverfolgbarkeit über 5+ Verarbeitungs- und Exportstandorte, in Zusammenarbeit mit CERES. Parallel habe ich für Kunden wie Muntigunung, Organic Island Foods und Kelorina den EU-Marktzugang für Moringa, Kakao, Cashew und Trockenfrüchte ermöglicht. Wer Compliance-Systeme für internationale Lieferketten aufbaut, versteht Verwendungsnachweise und Fördermittelprüfungen auf einer anderen Ebene.",
        "Nach der Rückkehr nach Deutschland (2019) habe ich als Operations Project Manager bei der Strukturpartner Pro GmbH 8+ Mandanten-Projekte gesteuert, darunter 5+ Transformationsprojekte mit Teams von 8–15 Personen und ein industrielles Hanf-Pilotprojekt in der Altmark (70 ha, 8 Landwirte). Entscheidungszyklen von ~5 auf ~2 Tage verkürzt. Diese Erfahrung in operativer Prozessoptimierung fließt direkt in die Projektsteuerung geförderter Vorhaben.",
        "Als Senior Grant Manager habe ich 6+ Förderprojekte mit einem Gesamtvolumen von über 0,8 Mio. Euro zur Bewilligung gebracht — von der Programmauswahl über Antragstellung mit Neuheitsnachweis und technischem Risiko bis zu Mittelabruf, Zwischennachweisen und Verwendungsnachweis. Programme: ZIM, INNO-KOM, TAB/FTI, EFRE, SAB, BAFA (EEW, BEG, Energieberatung), Forschungszulage, Horizon Europe, LIFE und BMWK-Sonderprogramme.",
        "Als ZIM-Netzwerkmanager für SEAWEED DECARBON POLYMER koordiniere ich ein internationales Konsortium mit 12+ Partnern aus Forschung und Industrie in 4 Ländern (DE, ES, MY, ID). Das Netzwerk umfasst ein Budget von 220.000 € bei ~95 % Förderquote in Phase 1 und entwickelt Technologien wie Triple-S-Zellaufschluss, BLUE OIL-Fermentation und BioMethanisierung. Dazu kommen Infrastrukturprojekte im Wert von über 500.000 € — Analyse-, Synthese- und Verarbeitungsmodule nach TAB/EFRE/BMWK-Anforderungen.",
        "VO Sustain bündelt diese Erfahrung in einer spezialisierten Förderberatung für KMU im Nachhaltigkeitsbereich: Cleantech, Kreislaufwirtschaft, Bioökonomie, Energieeffizienz und Dekarbonisierung. KI-gestützte Programmrecherche über 349 Förderprogramme — Bund, Länder und EU. Concept-Led statt reaktiv: Sie erhalten ein fertiges Förderkonzept vor dem ersten Gespräch, nicht erst danach.",
      ],
      statsLabel: "IN ZAHLEN",
      stats: [
        { value: ">0,8 Mio. €", label: "Bewilligtes Fördervolumen" },
        { value: "12+ Partner", label: "Im aktiven ZIM-Netzwerk" },
        { value: "4 Länder", label: "DE, ES, MY, ID" },
        { value: "349 Programme", label: "In der Förderdatenbank" },
        { value: "170+ Produzenten", label: "Bio-zertifiziert (Indonesien)" },
        { value: "10+ Programme", label: "ZIM, BAFA, EFRE, Horizon Europe …" },
      ],
      ...
      expertiseCards: [
        ...
        {
          title: "International Compliance & Audit",
          desc: "EU-Bio- und NOP-Zertifizierung, batch-basierte Rückverfolgbarkeit, CERES-Audits, Verwendungsnachweise. Aufgebaut für 170+ Produzenten über 280 ha in Südostasien.",
          tags: ["EU-Bio", "NOP", "Audit", "Rückverfolgbarkeit"],
        },
        {
          title: "Operations & Konsortialmanagement",
          desc: "Remote-Teams seit 2014, 12+ Partner in 4 Ländern, asynchrone Workflows, Entscheidungszyklen halbiert. Projektsteuerung für Forschungsverbünde und KMU-Transformationen.",
          tags: ["Remote", "12+ Partner", "Konsortium", "seit 2014"],
        },
      ],
  ...
  en: {
    ...
    ueberUns: {
      ...
      quote: "Eight years in the lab, five years building compliance systems for 170 smallholders in Indonesia, six approved grant projects in Germany — whoever has built traceability across international supply chains knows how to get every financial report approved.",
      bioParagraphs: [
        "My path into grant consulting started in the laboratory. Eight years of organic synthesis, HPLC/MS analytics, and lab management at CTA/ASCA GmbH Berlin (2006–2014) taught me how to document complex processes, produce verifiable results, and work under regulatory requirements. These are exactly the skills a grant application demands: evidencing technical risk, proving novelty, defining measurable milestones.",
        "In 2014 I moved to Indonesia. As Manager Supply Chain & Organic Compliance at Atlantis Handelskontor and as a freelance consultant, I built EU and NOP organic certifications for ~170 smallholder farmers across 280+ hectares — including batch-based traceability across 5+ processing and export sites, working with CERES. In parallel, I enabled EU market access for clients like Muntigunung, Organic Island Foods, and Kelorina for moringa, cocoa, cashew, and dried fruits. Building compliance systems for international supply chains means understanding financial reporting and grant audits at a different level.",
        "After returning to Germany (2019), I managed 8+ client projects as Operations Project Manager at Strukturpartner Pro GmbH, including 5+ transformation projects with teams of 8–15 people and an industrial hemp pilot project in the Altmark region (70 ha, 8 farmers). Decision cycles shortened from ~5 to ~2 days. This experience in operational process optimisation feeds directly into the management of funded projects.",
        "As Senior Grant Manager, I have brought 6+ funding projects with a total volume exceeding EUR 0.8M to approval — from programme selection through application with proof of novelty and technical risk to disbursement, interim reports, and final financial reporting. Programmes: ZIM, INNO-KOM, TAB/FTI, EFRE, SAB, BAFA (EEW, BEG, Energy Consulting), Research Allowance, Horizon Europe, LIFE, and BMWK special programmes.",
        "As ZIM Network Manager for SEAWEED DECARBON POLYMER, I coordinate an international consortium of 12+ research and industry partners across 4 countries (DE, ES, MY, ID). The network operates on a budget of EUR 220,000 with ~95% funding rate in Phase 1 and develops technologies including Triple-S cell disruption, BLUE OIL fermentation, and bio-methanisation. Additionally, infrastructure projects worth over EUR 500,000 — analysis, synthesis, and processing modules meeting TAB/EFRE/BMWK requirements.",
        "VO Sustain brings this experience together in a specialised grant consultancy for SMEs in the sustainability sector: cleantech, circular economy, bioeconomy, energy efficiency, and decarbonisation. AI-powered programme research across 349 funding programmes — federal, state, and EU. Concept-led, not reactive: you receive a complete funding proposal before the first meeting, not after.",
      ],
      statsLabel: "BY THE NUMBERS",
      stats: [
        { value: ">EUR 0.8M", label: "Approved grant volume" },
        { value: "12+ Partners", label: "In the active ZIM network" },
        { value: "4 Countries", label: "DE, ES, MY, ID" },
        { value: "349 Programmes", label: "In the funding database" },
        { value: "170+ Producers", label: "Organically certified (Indonesia)" },
        { value: "10+ Programmes", label: "ZIM, BAFA, EFRE, Horizon Europe …" },
      ],
      expertiseLabel: "EXPERTISE",
      ...
      expertiseCards: [
        ...
        {
          title: "International Compliance & Audit",
          desc: "EU organic and NOP certification, batch-based traceability, CERES audits, financial reporting. Built for 170+ producers across 280 ha in Southeast Asia.",
          tags: ["EU Organic", "NOP", "Audit", "Traceability"],
        },
        {
          title: "Operations & Consortium Management",
          desc: "Remote teams since 2014, 12+ partners across 4 countries, asynchronous workflows, decision cycles halved. Project management for research consortia and SME transformations.",
          tags: ["Remote", "12+ Partners", "Consortium", "since 2014"],
        },
      ],
