        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontFamily: "'Open Sans', sans-serif", fontSize: "0.875rem", color: "rgba(255,255,255,0.62)", lineHeight: 1.7, maxWidth: "320px", marginBottom: "1.25rem" }}>
                {t.footer.tagline}
              </p>
              <p style={{ fontFamily: "'Roboto Mono', monospace", fontSize: "0.65rem", color: "rgba(255,255,255,0.38)", letterSpacing: "0.06em" }}>
                {t.footer.location}
              </p>
            </div>
            ...
            {/* Navigation */}
            <div>
              <div style={{ fontFamily: "'Roboto Mono', monospace", fontSize: "0.6rem", color: "rgba(255,255,255,0.42)", letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: "1.5rem" }}>
                {t.footer.navLabel}
              </div>
              <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: "0.85rem" }}>
                {t.footer.navLinks.map((l) => (
                  <li key={l.href}>
                    <a
                      href={l.href}
                      style={{ fontFamily: "'Open Sans', sans-serif", fontSize: "0.875rem", color: "rgba(255,255,255,0.62)", textDecoration: "none", transition: "color 0.2s" }}
          ...
          <div style={{
            ...
            <p style={{ fontFamily: "'Roboto Mono', monospace", fontSize: "0.62rem", color: "rgba(255,255,255,0.32)", letterSpacing: "0.06em" }}>
            ...
            <div style={{ display: "flex", gap: "1.5rem" }}>
              {[
                ...
                <a
                  key={l.href}
                  href={l.href}
                  style={{ fontFamily: "'Roboto Mono', monospace", fontSize: "0.6rem", color: "rgba(255,255,255,0.32)", textDecoration: "none", letterSpacing: "0.06em", transition: "color 0.2s" }}
