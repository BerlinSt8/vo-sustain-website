...
export default function HeroSection() {
  ...
  return (
    ...
    >
      {/* Welle – parallax */}
      <motion.div style={{ position: "absolute", inset: "-20% 0 -20% 0", y: imageY, scale: imageScale }}>
        <img
          src="/welle.jpeg"
          alt={t.hero.imgAlt}
      ...
      {/* Navy overlay */}
      <motion.div style={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(8,15,26,0.2) 0%, rgba(13,27,42,0.5) 60%, rgba(8,15,26,0.9) 100%)", opacity: overlayOp }} />

      {/* Verde Glow */}
      <motion.div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse 60% 40% at 55% 32%, rgba(46,204,113,0.4) 0%, transparent 70%)", opacity: verdeGlow, pointerEvents: "none" }} />

      {/* Content */}
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "flex-start", padding: "0 8vw", paddingTop: "80px" }}>
        {/* Tag */}
        ...
        {/* Headline */}
        <motion.h1 style={{
          y: headlineY, opacity: headlineOp,
          fontFamily: "'Montserrat', sans-serif",
          fontSize: "clamp(3.5rem, 9vw, 7rem)",
          fontWeight: 900, color: "white", lineHeight: 0.95, letterSpacing: "-0.02em",
        ...
        <motion.div style={{ opacity: ctaOp, display: "flex", gap: "1rem", flexWrap: "wrap" }}>
          <a
            href="#quick-check"
            style={{
              fontFamily: "'Montserrat', sans-serif", fontSize: "0.9rem", fontWeight: 700,
              color: "white", background: "var(--verde)", textDecoration: "none",
              padding: "0.85rem 2rem", borderRadius: "var(--radius)", letterSpacing: "0.04em",
              transition: "background 0.2s, transform 0.2s", display: "inline-flex", alignItems: "center", gap: "8px",
            }}
          ...
          <a
            href="#leistungen"
            style={{
              fontFamily: "'Open Sans', sans-serif", fontSize: "0.9rem", fontWeight: 600,
              color: "rgba(255,255,255,0.8)", textDecoration: "none",
              padding: "0.85rem 1.75rem", borderRadius: "var(--radius)",
      ...
      {/* Scroll indicator */}
      <motion.div style={{ position: "absolute", bottom: "2rem", left: "50%", transform: "translateX(-50%)", opacity: headlineOp, display: "flex", flexDirection: "column", alignItems: "center", gap: "6px" }}>
